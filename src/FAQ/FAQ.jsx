  ...
  const FAQ = [
    {
      ...
      isShowed:true,
      description:
        "Yes we do! Please check the pricing tab for commonly stored non-box items. Pricing for unlisted items is handled on an individual basis. Please contact litterboxstorage@gmail.com to receive a quote.",
    },
    {
    ...
    },
    {
      ...
      isShowed:false,
      description: "Yes, you can provide your own boxes up to 6 cubic feet (ex. 2 ft x 2 ft x 1.5 ft). However, our boxes are extremely high-quality, double-walled boxes and they are included with every sign-up, so we recommend you use our boxes.",
    },
    {
      title: "DO I HAVE TO BUY MY BOXES?",
      isShowed:false,
      description: "No! The $40 reservation fee includes 5 large boxes, packaging tape, a marker, and sticker labels. If you want to buy additional boxes, we sell them for $5 each. However, our customers rarely need to purchase additional boxes.",
    },
    {
      title: "WHERE CAN I PICK UP MY BOXES?",
      isShowed:false,
      description: "We will announce 2024 box distribution days in Spring Quarter.",
    },
    {
    ...
    {
      title: " I’M LEAVING CAMPUS EARLY / COMING BACK TO CAMPUS EARLY. CAN I STILL STORE WITH LITTERBOX?",
      isShowed:false,
      description: "Yes! Our storing pickup and dropoff times are inclusive for students who need to leave/return earlier. The earliest pick-up time we offer is June 5th, and the earliest drop-off time is September 4th.",
    },
    {
        ...
        <div className="faqs flex flex-col gap-5">
            {state.map((f, index) => (
              ...
              >
                ...
                >
                  <h1 className="text-[14px] sm:text-[20px] uppercase">{f.title}</h1>
                  {!f.isShowed ? (
                    <button
                ...
                {f.isShowed && (
                  <p className="mt-2 text-slate-700 font-[500]">{f.description}</p>
                )}
              </div>
            ))}
          </div>
